...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        Config::set('sslcommerz.success_url', '/credit-success');
        Config::set('sslcommerz.failed_url', '/credit-fail');
        Config::set('sslcommerz.cancel_url', '/credit-cancel');
        Config::set('sslcommerz.ipn_url', '/credit-ipn');
    ...
    public function success(Request $request)
    {
        ...
        if ($order_detials->status == 'Pending') {
            ...
            if ($validation == true) {
                ...
                return redirect()->route('hosted.page');
            } else {
                /*
